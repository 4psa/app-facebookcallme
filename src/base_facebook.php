...
/* added by 4PSA - require the config file, in order to find out where to redirect the application once the user logs in*/
  ...
  public function getLoginUrl($params=array()) {
    ...
    return $this->getUrl(
      ...
      array_merge(array(
                    ...
                    'redirect_uri' => $_SESSION['REDIRECT_URI'], //currentURL possibly overwritten
                    'state' => $this->state),
                  $params));
  }
